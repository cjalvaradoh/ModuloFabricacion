    ...
    public class ReportesController : Controller
    {
        ...
        public async Task<IActionResult> GetData()
        {
            var data = new ReporteDataDto
            {
                ...
                OrdenesFinalizadas = await _context.OrdenProduccion
                    .CountAsync(o => o.Estado == "Finalizada" || o.Estado == "Completada"),
                OrdenesPendientes = await _context.OrdenProduccion
                    .CountAsync(o => o.Estado == "Pendiente"),
                OrdenesCanceladas = await _context.OrdenProduccion
                    .CountAsync(o => o.Estado == "Cancelada"), // Nuevo campo para canceladas
                IndiceRetrasos = await _context.OrdenProduccion
                    .CountAsync(o => o.FechaEntrega < DateTime.Now &&
                                   o.Estado != "Finalizada" &&
                                   o.Estado != "Completada" &&
                                   o.Estado != "Cancelada") // Excluir canceladas del índice de retrasos
            };
        ...
        public async Task<ActionResult<List<EstadoOrdenProduccionReporteDTO>>> ObtenerReporteEstadoOrdenes()
        {
            ...
            var resultadoCompleto = estadosRequeridos
                ...
                {
                    Estado = estado,
                    CantidadOrdenes = resultado.FirstOrDefault(r => r.Estado == estado)?.CantidadOrdenes ?? 0
                })
                .ToList();
